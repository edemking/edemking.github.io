...
const recklessNeue = localFont({
  src: "../fonts/Reckless-Neue-normal-500-100.otf",
});
const recklessNeueNormal = localFont({
  src: "../fonts/Reckless-Neue-normal-300-100.otf",
});
...
const Page = () => {
  ...
  const projects = [
    ...
    {
      id: 2,
      img: "/gb-hub-africa-website.png",
      title: "GB Hub Africa",
      desc: "Website",
      link: "https://gb-hub-africa.vercel.app",
    },
    {
      id: 3,
      img: "/top-star-shipping-website.png",
      title: "Top Star Shipping",
      desc: "Shipping Company Website",
      link: "https://topstarshippingweb.vercel.app",
    },
    {
      id: 4,
              ...
              <div className="h-full w-full flex justify-center items-center">
                <BlurIn className="">
                  ...
                  <SectionParagraph
                    ...
                    content="Crafting solutions that resonate with you"
                  />
                </BlurIn>
              </div>
            </div>
                  ...
                  <div className="flex flex-row justify-between">
                    <div>
                      <h3 className={`${projectTitle}`}>
                        <a
                          href="https://foods.wearediba.com"
                          target="_blank"
              ...
              {projects.map((project, idx) => {
                ...
                return (
                  <motion.div
                    ...
                    exit={{ scale: 0.9, opacity: 0 }}
                    key={idx}
                    className="col-span-12 lg:col-span-6 my-2 lg:my-0"
                  >
                    <div className="my-card p-4 lg:p-8 bg-[#141414]">
                      {/* {
                      ...
                      <div className="flex flex-col gap-8">
                        ...
                        <div className="flex flex-row justify-between">
                          <div>
                            <h3
                              className={`${projectTitle} text-xl lg:text-2xl`}
                            >
                              <a
                                href={project.link}
                                target="_blank"
