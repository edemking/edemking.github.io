...
const recklessNeue = localFont({
  src: "./fonts/Reckless-Neue-normal-100-100.otf",
});
...
const figtreeBoldItalic = localFont({
  src: "./fonts/figtree/Figtree-BoldItalic.ttf",
});
            ...
            <div className="grid grid-cols-12 h-full">
              <div className="col-span-12 lg:col-span-5 relative h-full text-center lg:text-left pt-[11vh] lg:pt-[35vh]">
                ...
                >
                  ...
                  <h1 className={headerStyle}>Web design &amp;</h1>
                  <h1 className={headerStyle}>custom site</h1>
                  <h1 className={headerStyle}>development</h1>
                ...
                <div className="lg:absolute lg:bottom-5 py-5 text-center lg:text-left">
                  <p className="text-[#7C3DFD] text-2xl">
                    <TextGradient content="Hello, David Here!" className="" />
                  </p>
                  <BlurIn>
                    <LiveTime />
                  </BlurIn>
              ...
              <div className="col-span-12 lg:col-span-7 relative h-full">
                <BlurIn>
                  <div className="group/headshot relative h-full w-full">
                    ...
                    <BlurIn
                      delay={1.5}
                      className="flex flex-col text-xs uppercase absolute bottom-15 -right-2 justify-center text-center gap-3"
                    >
          ...
          <div className="pt-[4em] lg:pt-[8em] pb-[4em] px-[1em] lg:px-0">
                    ...
                    <div className="grid grid-cols-12 gap-3">
                      ...
                      <PopIn className="cursor-pointer col-span-12 lg:col-span-4 my-card p-6 w-full bg-[#222222] flex flex-col justify-center items-center">
                        <p className="uppercase text-sm text-[#FFFFFF8C] text-center">
                          ...
                          <svg
                            className="animate-bounce mt-3 mx-auto"
                            width="33"
                            height="32"
                            viewBox="0 0 33 32"
                            fill="none"
                          ...
                          >
                            ...
                            >
                              <path
                                d="M32.0684 0H0.0683594V32H32.0684V0Z"
                                fill="white"
                              />
                            </mask>
                            <g mask="url(#mask0_353_2625)">
                              <g opacity="0.228527">
                                <path
                                  d="M12.8662 10.9609L16.0859 13.3609L19.2709 10.9609"
                                  stroke="white"
                                  strokeWidth="1.2268"
                                  strokeLinecap="round"
              ...
              <div className="col-span-12 lg:col-span-6">
                <div className="hidden lg:flex h-full items-center py-5 pl-5">
                  <TextFade
                    ...
                    className="pt-0 pb-5 items-center space-y-0"
                  >
                    <h2 className={headerStyle}>I am a Ghanaian</h2>
                    <h2 className={headerStyle}>Software Engineer who</h2>
                    <h2 className={headerStyle}>crafts solutions to the</h2>
                    <h2 className={headerStyle}>very detailed end.</h2>
                ...
                <div className="flex lg:hidden h-full items-center py-5 pl-5">
                  ...
                  >
                    <h2 className={headerStyle}>
                      I am a Ghanaian Software Engineer who crafts solutions to
                      the very detailed end.
                    </h2>
                    <div className="lg:text-left w-full uppercase mt-10">
                      <TextFade direction="down">
                        <p className="">Helping you build beautiful and</p>
            ...
            <div className="grid grid-cols-12 gap-5 text-xl mt-5">
              <div className="col-span-12 lg:col-span-8 grid grid-cols-12 gap-5">
                <BlurIn className="col-span-12 lg:col-span-6 relative my-card p-5 px-6 bg-[#3f3f3f48]">
                  <p>
                    I&apos;m a{" "}
                    <TextGradient
                      content={"selectively skilled"}
                      className={""}
                    />{" "}
                    software engineer with strong focus on crafting digital
                ...
                <BlurIn className="col-span-12 lg:col-span-6 relative my-card p-5 px-6 bg-[#3f3f3f48]">
                  <p className="uppercase">
                    <TextGradient content={"Education"} className={""} />
                  </p>
                  <div className="py-3"></div>
                  <div className="grid grid-cols-12 gap-3">
                    ...
                    <div className="col-span-8">
                      ...
                      <p className="text-[#7C7C7C] mb-4 text-base">
                ...
                <BlurIn className="col-span-12 lg:col-span-6 relative my-card p-5 px-6 bg-[#3f3f3f48]">
                  <p className="uppercase">
                    <TextGradient content={"My playlist"} className={""} />
                  </p>
                  <div className="py-2"></div>
                  <BlurIn>
                    <iframe
                      style={{ borderRadius: "12px", marginBottom: "8px" }}
                      src="https://open.spotify.com/embed/track/2twcZTB1udOEzDCPpTiOju?utm_source=generator"
                      width="100%"
                      height="80"
                      frameBorder="0"
                      allowFullScreen
                  ...
                  <BlurIn>
                    <iframe
                      ...
                      src="https://open.spotify.com/embed/track/6dSUujR460zx2N7868TuBI?utm_source=generator"
                      width="100%"
                      height="80"
                      frameBorder="0"
                      allowFullScreen
                ...
                <BlurIn className="col-span-12 lg:col-span-6 relative my-card p-5 px-6 bg-[#3f3f3f48] flex flex-col justify-between">
                  <p className="uppercase">
                    <TextGradient content={"motivation"} className={""} />
                  </p>
                  <div className="">
                    ...
                    <div className="flex flex-row justify-between">
                      ...
                      >
                        <path
                          d="M20 30C23.1755 30 25.6627 29.1227 27.3927 27.3927C29.1227 25.6627 30 23.1755 30 20L30 1.09278e-06L17.5 0L17.5 20H25C25 21.8012 24.6155 23.0989 23.8573 23.8573C23.0989 24.6155 21.8012 25 20 25"
                          fill="#2E2E2E"
                        />
                        <path
                          d="M2.5 30C5.67547 30 8.16273 29.1227 9.89273 27.3927C11.6227 25.6627 12.5 23.1755 12.5 20L12.5 1.09278e-06L1.74846e-06 0L0 20H7.5C7.5 21.8012 7.11547 23.0989 6.35726 23.8573C5.5989 24.6155 4.30125 25 2.5 25"
                          fill="#2E2E2E"
                        />
                      </svg>
                      <div className="flex flex-col">
                        <p className="text-right">
                          <TextGradient
                            content={"- Dr. Thomas A. Ndanu"}
                            className=""
                          />
                        </p>
                        <p className="text-right mt-1">
                          <span className="bg-[#252525] rounded-full py-1 px-3 text-base">
                            My Dad 😅
                          </span>
                        </p>
                      </div>
              ...
              <BlurIn className="col-span-12 lg:col-span-4 relative my-card bg-[#3f3f3f48] p-5 px-6">
                <p className="uppercase">
                  <TextGradient content={"Experience"} className={""} />
                </p>
                ...
                <div className="lg:h-[19em] overflow-auto">
                  {experience.map((exp, index) => (
                    <BlurIn key={index}>
                      <div
                        className={`border-b border-b-[#3c3c3c] grid grid-cols-12 gap-3 py-5`}
                      >
                        <div className="col-span-4">
            ...
            <div className="text-right w-full justify-end pt-10 flex">
              <ActionButton
                keyVal={"aboutMe"}
                link="/about"
                name="More about myself"
                target="_top"
                className={"font-bold"}
              />
            </div>
            {/* <div className="pt-[8em] w-full">
              <MagicBento />
            </div> */}
          </div>
        </div>
        <div className="col-span-12 overflow-hidden" ref={marqueeRef}>
          <AnimatePresence>
            <motion.div
              ...
              <div className="relative w-screen h-[10em] lg:h-[20em] overflow-hidden mt-8">
                ...
                >
                  <BlockSectionText className="">
                    <h2
                      style={{}}
                      className={`${figtreeRegular.className} uppercase text-[12vw] flex flex-row gap-10 items-center`}
                    >
                      Select
                      <span className={`${figtreeBoldItalic.className}`}>
                        Work
                      </span>
                      <svg
                        width="141"
                      ...
                      <span className="text-[#282828]">Select</span>
                      <span
                        className={`${figtreeBoldItalic.className} text-[#282828]`}
                      >
                        Work
                      </span>
                      <svg
            ...
            >
              <div className="relative w-screen h-[25em] overflow-x-hidden mt-8">
                <motion.div
                  ...
                  className={`${figtreeBold.className} absolute gap-4 left-0 flex`}
                >
